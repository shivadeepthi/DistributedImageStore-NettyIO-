...
_HEADER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='replica', full_name='Header.replica', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='path', full_name='Header.path', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='toNode', full_name='Header.toNode', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='options', full_name='Header.options', index=10,
